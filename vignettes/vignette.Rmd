...
- which variables represent total assimilation (default tag is "ass")  
- which variables represent total growth (secondary production, default tag is "growth")  
