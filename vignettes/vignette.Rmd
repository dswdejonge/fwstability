...
We want the upper-limit of intraspecific effects on the diagonal (thus the maximum amount of possible self-dampening effects on the system), thus we specify in our model how we want the function to treat the diagonal.  Beware that the unit of the Jacobian matrix is only per unit time if the input biomass is biomass per unit area (or volume) and and the fluxes unit is biomass per unit area (or volume) per unit time. If you use other units, please refer to the paper how this influences the interpretation of your results.
