...
The effect of a predator on its prey ($\alpha_{ij}$) is calculated as:
...
where $n$ is the total number of compartments in the food web. The equation is derived from the equation in Neutel & Thorne (2014):
